...
- **MCP discoverability**: improved MCP server instructions and `migrate_vault` tool description so agents correctly call the migration tool instead of searching the web when asked to "migrate to LLM Wiki pattern"
